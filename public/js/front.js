...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    sendForm: function sendForm() {
      ...
      this.sendingInProgress = true; //invio i valori inseriti nei campi input 
      ...
      axios.post('/api/contacts', {
        ...
        if (response.data.errors) {
          _this.errorsData = response.data.errors;
          _this.successSend = false;
        } else {
          //mostro così l'alert del corretto invio della mail
          _this.successSend = true; //reset campi

          _this.name = '', _this.email = '', _this.message = '', _this.errorsData = {};
        }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getPostList: function getPostList(pageNumber) {
      var _this = this;
      ...
      axios.get('/api/posts', {
        ...
        _this.postList = response.data.results.data;
...
var render = function () {
  ...
  return _c("div", { attrs: { id: "header" } }, [
    _c("nav", { staticClass: "navbar navbar-expand-lg navbar-dark bg-dark" }, [
      ...
      _vm._v(" "),
      _c("ul", { staticClass: "navbar-nav mr-auto flex-row" }, [
        _c(
          "li",
...
var staticRenderFns = [
  function () {
    ...
    return _c("div", { attrs: { id: "about" } }, [
      ...
      _c("p", [
        _vm._v(
          "Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti nulla \n      possimus cum, modi, illo expedita non laudantium reprehenderit, aperiam pariatur quis omnis vel molestias \n      neque cumque eveniet eius! Sit, sunt?"
        ),
      ]),
    ])
  },
            ...
            _c(
              ...
              [
                ...
                _c("input", {
                  ...
                  class: { "is-invalid": _vm.errorsData.name },
                ...
                _vm._v(" "),
                _vm._l(_vm.errorsData.name, function (error, index) {
                  return _c(
                    "p",
                    {
            ...
            _c(
              ...
              [
                ...
                _c("input", {
                  ...
                  staticClass: "form-control",
                  class: { "is-invalid": _vm.errorsData.email },
                ...
                _vm._v(" "),
                _vm._l(_vm.errorsData.email, function (error, index) {
                  return _c(
                    "p",
                    {
            ...
            _c(
              ...
              [
                ...
                _c("textarea", {
                  ...
                  staticClass: "form-control",
                  class: { "is-invalid": _vm.errorsData.message },
                  attrs: {
                    type: "text",
                    id: "message",
                    rows: "5",
                ...
                _vm._v(" "),
                _vm._l(_vm.errorsData.message, function (error, index) {
                  return _c(
                    "p",
                    {
...
var render = function () {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("h1", [_vm._v("Pagina di prova")])
}
var staticRenderFns = []
render._withStripped = true
...
var render = function () {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-7 pt-5 m-auto" }, [
        _vm.post
          ? _c(
              "div",
              [
                ...
                _vm._l(_vm.post.tags, function (tag) {
                  return _c(
                    "span",
                    { key: tag.id, staticClass: "badge bg-primary p-2 ml-2" },
...
module.exports = __webpack_require__(/*! C:\Users\serbo\Desktop\GitHub_folder\laravel-boolpress\resources\js\front.js */"./resources/js/front.js");
